...
const Suggestion = () => {
    return (
        <div>
            <div className="grid grid-cols-4 w-auto mx-auto gap-2 p-4">
                <div >
                   <div className="card h-80 lg:h-96 mt-20  mb-6 p-4 text-center items-center bg-cyan-100 justify-center shadow-xl " data-aos="fade-up-right">
                ...
                <div >
                   <div className="card h-80 lg:h-96 mt-20  mb-6 p-4 text-center items-center bg-rose-200 justify-center shadow-xl  " data-aos="flip-left"
     ...
     data-aos-duration="2000">
                ...
                <div >
                   <div className="card h-80 lg:h-96 mt-20  mb-6 p-4 text-center items-center  bg-blue-200 justify-center shadow-xl " data-aos="fade-up">
                ...
                <div >
                   <div className="card h-80 lg:h-96 mt-20  mb-6 p-4 text-center items-center bg-fuchsia-300  justify-center shadow-xl " data-aos="fade-up-left">
